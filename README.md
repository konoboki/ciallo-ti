...
v1.0.1
优化假屋和奏，芦花姐立绘，新增github star导航
新增角色：阳见惠凪，布良梓，并更新 ENFJ/ISTJ 匹配结果。
增加概率展示：由于栞那在旧版本中曾对应两个结果、现已调整为一个，为避免历史数据在短时间内造成偏差，24 小时内将对其出现概率进行临时修正（显示值减半）；明日恢复为正常统计口径。
...
新增功能：柚子社老资历扩展角色测试选项，共计32个角色，新增6道题目，会涵盖更多作品
这两天还挺忙的，大更新得等明天晚上
