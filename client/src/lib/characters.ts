...
export const characters: Character[] = [
  ...
  { id: "anju", name: "隐杏珠", nameJa: "隠 杏珠", game: "天使☆嚣嚣 RE-BOOT!", mbti: "闪光弹的主人", characterMbti: "ENFP", identity: "R", color: "#FFE8D5", image: "/characters/kakure-anju.png", description: 'ISFJ 会被隐杏珠这种 ENFP 型吸引，是因为她表面闪闪发光、很会带动气氛，内里却不是单纯没心没肺，而是有很多想被真正看见、真正认可的部分。对稳定、照顾型的 ISFJ 来说，这种人很容易激起保护欲和陪伴欲：你会觉得她很耀眼，但又不是遥不可及，而是一个需要被好好接住的女孩子。' },
  ...
  { id: "elina", name: "艾莉娜·欧列格夫娜·欧文", nameJa: "エリナ・オレゴヴナ・アヴェーン", game: "DRACU-RIOT!", mbti: "工口娜", characterMbti: "ENFP", identity: "R", color: "#F5D5FF", image: "/characters/elina-owen.png", description: 'INFJ 很容易被艾莉娜这种 ENFP 型戳中。她表面是会开玩笑、会拱火、会把场面搅热的白毛吸血鬼，实际内核却很怕被拒绝，也很在意自己能不能被真正接受。对 INFJ 来说，她既能把你从安静的内心世界里拖出来，又会在熟悉之后露出敏感和不安，这种“外放壳 + 脆弱内核”的反差很有杀伤力。' },
  ...
  { id: "chihaya", name: "上坂茅羽耶", nameJa: "上坂 茅羽耶", game: "LimeLight Lemonade Jam", mbti: "草帽飞向何方", characterMbti: "INFP", identity: "R", color: "#F5E8D5", image: "/characters/uesaka-chihaya.png", description: 'ISFP 会被上坂茅羽耶这种 INFP 型吸引，是因为她身上有很强的梦幻感、脆弱感和个人情绪深度。她不是强势推着你走的人，而是安静、柔软、带着一点会消失的透明感，让你忍不住想靠近、想理解、想把她从不安里拉住。对重视感受和氛围的 ISFP 来说，茅羽耶的魅力就在于她像一段很轻的梦，但情绪重量又真实得让人放不下。' },
