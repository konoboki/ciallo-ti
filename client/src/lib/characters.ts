...
export const mbtiMatchDescription: Record<string, string> = {
  ...
  ENFP: ' “钝钝钝器~” 你可能会被四季夏目这种冷静、克制、带点距离感的人吸引。她不是热闹型，但越接近越能发现她认真、敏感又有标准的一面，这种"外冷内热"（六套战神）的反差，对喜欢挖掘他人内心的 ENFP 很有吸引力。',
  ...
  INTP: " “bro真的能拔出丛雨丸” 因为丛雨这种 INFJ 型很容易戳中 INTP 最吃的那点——安静、聪明、带一点疏离感，但其实一直在默默观察你、照顾你、把你的状态看在眼里。她一出场就是那种不喧闹、先看清局势再开口的人，而且不是单纯冷淡，而是有一种很稳的陪伴感：对 INTP 来说，这种人很有吸引力，因为她不是靠热闹来压你，而是用一种理解感、深度感、安定感把你慢慢拉近。",
