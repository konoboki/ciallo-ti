...
export const mbtiMatchDescription: Record<string, string> = {
  ...
  ENFJ: "你可能会被三司绫濑这种安静、真诚、情感很纯的人吸引。她不靠张扬取胜，而是靠细腻和真实打动人（*锉刀），这种需要被理解、也值得被珍惜的气质，往往很能激发 ENFJ 的保护欲和投入感。",
  ...
  ISTJ: '你可能会被假屋和奏这种活泼、真实、带点小脾气但很有温度的人吸引。她能打破过于单调的生活节奏，又不会让人觉得虚浮，对偏稳重的 ISTJ 来说，这种"热闹但不空"的类型很有魅力。',
